...
export default function App() {
    ...
    return (
      <ScrollView>
        ...
        />
        <Text style={{fontFamily: "OpenSans-SemiBold", fontSize: 35, textAlign: 'center'}}> Bulgarian Split Squat Jumps </Text>
        ...
        <Text style={{fontFamily: "OpenSans-Reg", fontSize: 20, marginTop: 10}}> 4. Drive up through your front heel and jump </Text>
