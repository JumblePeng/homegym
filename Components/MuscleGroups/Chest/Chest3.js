...
export default function App() {
    ...
    return (
      <ScrollView>
        ...
        />
        <Text style={{fontFamily: "OpenSans-SemiBold", fontSize: 35, textAlign: 'center'}}> Alternating Shuffle Push-Up </Text>
        ...
        <Text style={{fontFamily: "OpenSans-Reg", fontSize: 20, marginTop: 10}}> 5. Repeat and move body slightly left or right </Text>
      </ScrollView>
    );
  }