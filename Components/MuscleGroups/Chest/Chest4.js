...
export default function App() {
    ...
    return (
      <ScrollView>
        ...
        />
        <Text style={{fontFamily: "OpenSans-SemiBold", fontSize: 35, textAlign: 'center'}}> Diamond Push-Up </Text>
        ...
        <Text style={{fontFamily: "OpenSans-Reg", fontSize: 20, marginTop: 10}}> 1. Go down on all fours, placing your hands touching together like a dimaond </Text>
